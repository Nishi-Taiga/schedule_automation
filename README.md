...
[![Version](https://img.shields.io/badge/version-1.3-blue.svg)](https://github.com/Nishi-Taiga/schedule_automation)
...
**Q: 複数の週をまとめて処理できますか？**
A: 現在は1週間分の処理を想定していますが、ブース表と講師表に複数週のデータが含まれている場合は自動的に処理されます。
