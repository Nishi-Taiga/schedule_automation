"""Playwright E2E test for schedule_automation v0.12.8 deployed environment."""
import sys
...
def run_tests():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.wait_for_selector("text=v0.12.8", timeout=30000)
            page.screenshot(path=os.path.join(SCREENSHOT_DIR, "01_login.png"))
            print("  PASS: Login successful, v0.12.8 confirmed")
        ...
        try:
            ...
            page2.wait_for_selector("text=v0.12.8", timeout=15000)
            ...
            if is_disabled:
                ...
                page2.screenshot(path=os.path.join(SCREENSHOT_DIR, "06c_json_restored.png"))
                ...
                try:
                    ...
                    if ok2:
                        print("  PASS: JSON restore + download with booth sheets")
                    else:
                        print("  WARN: No booth sheets after JSON restore")
                except Exception as dl_e:
                    page2.screenshot(path=os.path.join(SCREENSHOT_DIR, "06d_dl_fail.png"))
        ...
        print("[Test 7] Excel restore -> download booth sheets (v0.12.8 key test)...")
        ...
        if os.path.exists(restore_file):
            ...
            try:
                ...
                page3.wait_for_selector("text=v0.12.8", timeout=15000)
    ...
    # Summary
    print("\n" + "=" * 50)
    print("E2E Test Summary (v0.12.8)")
    print("=" * 50)
