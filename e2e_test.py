"""Playwright E2E test for schedule_automation v0.19.0 deployed environment."""
import sys
...
def run_tests():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.wait_for_selector("text=v0.19.0", timeout=30000)
            page.screenshot(path=os.path.join(SCREENSHOT_DIR, "01_login.png"))
            print("  PASS: Login successful, v0.19.0 confirmed")
        ...
        try:
            ...
            page2.wait_for_selector("text=v0.19.0", timeout=15000)
            ...
            if is_disabled:
                ...
                restore_btn.click()
                # v0.19.0: JSON restore now goes to settings screen first
        ...
        print("[Test 7] Excel restore -> download booth sheets (v0.19.0 key test)...")
        ...
        if os.path.exists(restore_file):
            ...
            try:
                ...
                page3.wait_for_selector("text=v0.19.0", timeout=15000)
    ...
    # Summary
    print("\n" + "=" * 50)
    print("E2E Test Summary (v0.19.0)")
    print("=" * 50)
